...
public class Parser {
    public static String studentName = "TODO: Raymond Wang";
    public static String studentID = "TODO: 17769107";
    public static String uciNetID = "TODO: raymoncw";
...
// SymbolTable Management ==========================
    ...
    private void initSymbolTable()
    {
        ...
        s.setType(new FuncType(args, new IntType()));
        s = symbolTable.insert("readFloat");
        args = new TypeList();
        args.append(new FloatType());
        s.setType(new FuncType(args, new FloatType()));
        s = symbolTable.insert("printBool");
        args = new TypeList();
        args.append(new BoolType());
        s.setType(new FuncType(args, new BoolType()));
...
// Grammar Rules =====================================================
    ...
    public Type type()
    {
        ...
        type = tryResolveType(expectIdentifier());
    ...
    */
    ...
    public ast.FunctionDefinition function_definition()
    {
        ...
        expect(Token.Kind.CLOSE_PAREN);
        expect(Token.Kind.COLON);
        TypeList paramsType = new TypeList();
        params.forEach(x -> { paramsType.append(x.type()); });
        sym.setType(new FuncType(paramsType, type()));
